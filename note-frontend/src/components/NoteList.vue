<template>
  <div class="mt-4 relative">
      ...
      >
        <div class="flex justify-between items-start mb-4">
          <span
            ...
            :class="{
              'bg-red-200 text-red-800': note.category === 'Work',
              'bg-blue-200 text-blue-800': note.category === 'Personal',
              'bg-green-200 text-green-800': note.category === 'Shopping',
              'bg-yellow-200 text-yellow-800': note.category === 'Study',
              'bg-purple-200 text-purple-800': note.category === 'Health',
              'bg-indigo-200 text-indigo-800': note.category === 'Travel'
            }"
          >
            {{ note.category || 'N/A' }}
          </span>
    ...
    <p v-if="filteredNotes.length === 0" class="mt-2 text-gray-500">No notes found.</p>
        ...
        <div class="p-6">
          <div class="flex justify-between items-start mb-4">
            <span
              class="text-xs font-semibold px-2 py-1 rounded-full"
              :class="{
                'bg-red-200 text-red-800': selectedNote.category === 'Work',
                'bg-blue-200 text-blue-800': selectedNote.category === 'Personal',
                'bg-green-200 text-green-800': selectedNote.category === 'Shopping',
                'bg-yellow-200 text-yellow-800': selectedNote.category === 'Study',
                'bg-purple-200 text-purple-800': selectedNote.category === 'Health',
                'bg-indigo-200 text-indigo-800': selectedNote.category === 'Travel'
              }"
            >
          ...
          <h2 class="text-2xl font-bold mb-4">{{ selectedNote.title }}</h2>
          
          <div class="prose max-w-none">
            <p class="whitespace-pre-line">{{ selectedNote.body }}</p>
          </div>
...
@media (max-width: 640px) {
  ...
  /* Remove horizontal spacing utility */
  .flex.space-x-2 > * + * {
    margin-left: 0;
  }
}
